...
public class Main {
    public static void main(String[] args) {
        ...
        // Crear gerencia y atención al cliente
        ...
        // 10. Probar cancelación de reserva con GestorReservas
        System.out.println("\n=== Cancelación de reserva ===");
        GestorReservas gestor = new GestorReservas();
        gestor.procesarAccion(usuario2, reservaMaria, "R");
